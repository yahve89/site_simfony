...
class ReviewController extends AbstractController
{
    ...
    {
        $review = new Review();
        $review->setAddedAt(new \DateTime());
    ...
    /**
     * @Route("/show", name="review_show", methods={"GET"})
     */
    public function show(ReviewRepository $reviewRepository, Request $request): Response
    {
        return $this->render('review/show.html.twig', [
           'reviews' => $reviewRepository->findAllByStatus(),
